...
export function CharacterPanel({
  ...
  return (
    <div className="w-80 bg-fantasy-card/80 backdrop-blur-sm border-l border-fantasy-accent/10 flex flex-col">
      <div className="p-4 border-b border-fantasy-accent/10 flex items-center justify-between">
        <h2 className="font-semibold text-fantasy-text">队伍状态</h2>
        <button
          onClick={onClose}
          className="text-fantasy-muted hover:text-fantasy-text transition-colors"
        >
          ✕
        </button>
      </div>
      ...
      {/* Cooperation modal */}
      {cooperationTarget && (
        <div className="p-4 border-t border-fantasy-accent/10">
